<?php 
	...
	if(isset($_POST['Submit'])){
		...
		if(count($errors)==0) {
		$query = "UPDATE profile SET fname = '$fname', lname = '$lname', dob = '$dob', phone_number = '$phone', experience = '$exp', resume = '$resume', resume_name = '$resumename', city_id = '$city', acd_id = '$ledu' WHERE user_id = '$userid' ";
		$sql = mysqli_query($conn,$query);
		echo "<center><div id='show'><h2>U have successfully updated your profile</h2><button onclick='gotopage()'>Next</button></div></center>";
		}
	}
...
<form action="" method="POST" enctype="multipart/form-data">
	<table align="center" style=" padding-top: 100px; line-height: 250%; overflow: auto;" >
<tr>
	<td>First Name</td>
	<td>:</td>
...
<tr>
	<td>Phone Number</td>
	<td>:</td>
	<td><input type="text" name="Pnumber" value="<?php echo $phone?>" required></td>
</tr>
...
<tr>
	<td>Experiences</td>
	<td>:</td>
	<td><textarea rows="4" cols="50" name="exp"><?php echo $exp; ?></textarea></td>
	</td>
</tr>
<tr>
